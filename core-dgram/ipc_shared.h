...
struct cpu_ipc_entry {
	...
	volatile   uintptr_t sbuf_addr;
	volatile   int       sbuf_size;
	volatile   uintptr_t dev_sbuf_free_queue_back;
	volatile   uintptr_t dev_sbuf_free_queue;
	volatile   uintptr_t host_sbuf_req_queue;
	volatile   uintptr_t dev_sbuf_req_back;
	volatile   uintptr_t host_sbuf_req_back;

	volatile   int       rbuf_size;	
	volatile   uintptr_t dev_rbuf_recved_queue;
	volatile   uintptr_t dev_rbuf_recved_back;
	volatile   uintptr_t host_rbuf_ack_queue_back;
